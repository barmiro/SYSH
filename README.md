...
At the time of writing, SYSH is composed of a dockerized server, which collects data from Spotify and direct JSON imports, and an android client on very early stages of development. A web client is on the roadmap, but not very high up.
